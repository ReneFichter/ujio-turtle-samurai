...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function renderShortsCarousel() {
    ...
    prevDiv.innerHTML = `<div class='shorts-card-iframe'><iframe src='${shortsVideos[prev].url}' title='${shortsVideos[prev].title}' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe></div>`;
    ...
    nextDiv.innerHTML = `<div class='shorts-card-iframe'><iframe src='${shortsVideos[next].url}' title='${shortsVideos[next].title}' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe></div>`;
